...
if(!empty($_POST['cp101_vin'])){
 ...
 if(strlen($vin)!=17){
   ...
   if(is_wp_error($vehicle)){
      ...
      $fields=[
       'Make'=>'Make','Model'=>'Model','Model Year'=>'ModelYear','Series'=>'Series','Trim'=>'Trim','Body Class'=>'BodyClass','Engine'=>'EngineModel','Fuel Type'=>'FuelTypePrimary','Drive Type'=>'DriveType','Transmission'=>'TransmissionStyle'
      ];
